...
export function createMap() {
  ...
  for(const [kind,positions] of Object.entries({
    berry:[[27,37],[42,38],[48,47],[30,24],[21,35],[52,41]],
    mushroom:[[27,25],[41,23],[22,38],[50,28],[53,45],[30,50]],
    wood:[[24,31],[44,25],[50,40],[28,46],[21,28],[47,51]],
  })) positions.forEach(([x,y],i)=>resources.push({id:`${kind}-${i}`,kind,x,y,readyAt:0}));
  const spawns = [
